...
const DICE = (function() {
    ...
    var vars = { //todo: make these configurable on init
        ...
        material_options: {
            specular: 0x172022,
            color: 0xf0f0f0, // Light gray for better lighting contrast
            shininess: 40,
            shading: THREE.FlatShading,
        },
        label_color: '#ff2600', // Dungeon Church red numbers
        dice_color: '#202020', // Dark gray dice body
        ambient_light_color: 0xf0f0f0,
        spot_light_color: 0xefefef,
        desk_color: '#101010', //canvas background
        desk_opacity: 0, // Fully transparent background
        use_shadows: true,
